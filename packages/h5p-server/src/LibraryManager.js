...
var LibraryManager = /** @class */ (function () {
    ...
    LibraryManager.prototype.getLanguage = function (library, language) {
        return __awaiter(this, void 0, void 0, function () {
            var cleanLanguage, ignored_1, variantList, _i, variantList_1, variant, _a, languageCodeMatch, _b, _c, _d, _e;
            var _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 3:
                        ...
                        variantList = (_f = variantEquivalents_json_1.default
                            .find(function (l) { return l.includes(cleanLanguage); })) === null || _f === void 0 ? void 0 : _f.filter(function (v) { return v !== cleanLanguage; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("library: " + LibraryName_1.default.toUberName(library));
     ...
     * installed).
     */
    LibraryManager.prototype.installFromDirectory = function (directory_1) {
        return __awaiter(this, arguments, void 0, function (directory, restricted) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fsExtra.readJSON("".concat(directory, "/library.json"))];
                    case 1:
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(files.map(function (fileFullPath) {
                                ...
                                var readStream = fsExtra.createReadStream(fileFullPath);
                                return _this.libraryStorage.addFile(libraryInfo, upath.toUnix(fileLocalPath), readStream);
                            }))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
