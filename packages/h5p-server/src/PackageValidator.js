...
var PackageValidator = /** @class */ (function () {
    ...
    function PackageValidator(config, libraryManager) {
         ...
         */
        this.libraryLanguageFilesMustBeValid = function (_a, pathPrefix_1, error_1) { return __awaiter(_this, [_a, pathPrefix_1, error_1], void 0, function (_b, pathPrefix, error) {
            var uberName, languagePath, _i, _c, languageFile, languageFileName, ignored_1;
            var filenames = _b.filenames, jsonData = _b.jsonData;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        languagePath = upath.join(uberName, 'language/');
                        _i = 0, _c = filenames.filter(function (f) {
        ...
        this.skipInstalledLibraries = function (skipInstalledLibraries) {
            return function (_a, pathPrefix_1, error_1) { return __awaiter(_this, [_a, pathPrefix_1, error_1], void 0, function (_b, pathPrefix, error) {
                var _c, _d;
                var filenames = _b.filenames, jsonData = _b.jsonData;
         ...
         */
        this.libraryPreloadedFilesMustExist = function (_a, pathPrefix_1, error_1) { return __awaiter(_this, [_a, pathPrefix_1, error_1], void 0, function (_b, pathPrefix, error) {
            var uberName;
            var _this = this;
            var filenames = _b.filenames, jsonData = _b.jsonData;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(jsonData.preloadedJs.map(function (file) {
                                return _this.fileMustExist(upath.join(uberName, file.path), 'library-file-missing', false, { filename: file.path, library: uberName })(filenames, pathPrefix, error);
                            }))];
                    case 1:
                        _c.sent();
                        _c.label = 2;
         ...
         * @returns the unchanged data passed to the rule
         */
        this.mustBeCompatibleToCoreVersion = function (_a, pathPrefix_1, error_1) { return __awaiter(_this, [_a, pathPrefix_1, error_1], void 0, function (_b, pathPrefix, error) {
            var filenames = _b.filenames, jsonData = _b.jsonData;
            return __generator(this, function (_c) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fsExtra.readdir(pathPrefix, { withFileTypes: true })];
     ...
     */
    PackageValidator.prototype.validateExtractedPackage = function (packagePath_1) {
        return __awaiter(this, arguments, void 0, function (packagePath, checkContent, checkLibraries, skipInstalledLibraries) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        files = (_a.sent()).map(function (f) {
                            return upath.toUnix(f.substr(packagePathLength));
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fsExtra.readJSON(path.join(__dirname, 'schemas/h5p-schema.json'))];
                    case 1:
                        h5pJsonSchema = _a.sent();
                        return [4 /*yield*/, fsExtra.readJSON(path.join(__dirname, 'schemas/library-name-schema.json'))];
                    case 2:
                        libraryNameSchema = _a.sent();
                        return [4 /*yield*/, fsExtra.readJSON(path.join(__dirname, 'schemas/library-schema.json'))];
                    case 3:
        ...
        return function (filenames, pathPrefix, error) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fsExtra.readJSON(path.join(pathPrefix, file))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fsExtra.readJson(filename)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
