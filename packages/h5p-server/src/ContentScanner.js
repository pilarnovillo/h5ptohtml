...
var ContentScanner = /** @class */ (function () {
     ...
     */
    ContentScanner.prototype.walkEntryRecursive = function (elementSemantics_1, elementParams_1, parentJsonPath_1, parentParams_1, callback_1) {
        return __awaiter(this, arguments, void 0, function (elementSemantics, elementParams, parentJsonPath, parentParams, callback, options) {
            var currentJsonPath, _a, subLibraryName, subSemantics, _i, _b, groupElement, counter, _c, elementParams_2, listElement;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 11:
                        counter = 0;
                        _c = 0, elementParams_2 = elementParams;
                        _d.label = 12;
                    case 12:
                        if (!(_c < elementParams_2.length)) return [3 /*break*/, 15];
                        listElement = elementParams_2[_c];
     ...
     */
    ContentScanner.prototype.walkSemanticsRecursive = function (semantics_1, params_1, parentJsonPath_1, callback_1) {
        return __awaiter(this, arguments, void 0, function (semantics, params, parentJsonPath, callback, options) {
            var _i, semantics_2, semanticEntry;
            if (options === void 0) { options = {
                doNotAddNameToJsonPath: false
            }; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _i = 0, semantics_2 = semantics;
                        _a.label = 1;
                    case 1:
                        if (!(_i < semantics_2.length)) return [3 /*break*/, 4];
                        semanticEntry = semantics_2[_i];
