...
var DirectoryTemporaryFileStorage = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fsExtra.remove(filePath)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fsExtra.remove("".concat(filePath, ".metadata"))];
                    case 2:
                        _a.sent();
    ...
    DirectoryTemporaryFileStorage.prototype.fileExists = function (filename, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, fsExtra.pathExists(filePath)];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        filePath = this.getAbsoluteFilePath(user.id, filename);
                        return [2 /*return*/, fsExtra.stat(filePath)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, fsExtra.createReadStream(filePath, {
                                start: rangeStart,
                                end: rangeEnd
                            })];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = [user.id];
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, fsExtra.readdir(this.directory)];
                    case 2:
                        _a = _b.sent();
                        _b.label = 3;
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, filenameUtils_1.checkFilename)(filename);
                        (0, filenameUtils_1.checkFilename)(user.id);
                        return [4 /*yield*/, fsExtra.ensureDir(this.getAbsoluteUserDirectoryPath(user.id))];
                    case 1:
                        _a.sent();
                        filePath = this.getAbsoluteFilePath(user.id, filename);
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, fsExtra.writeJSON("".concat(filePath, ".metadata"), {
    ...
    DirectoryTemporaryFileStorage.prototype.deleteEmptyDirectory = function (directory) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fsExtra.readdir(directory)];
                    case 1:
                        files = _a.sent();
                        if (!(files.length === 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, fsExtra.rmdir(directory)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    DirectoryTemporaryFileStorage.prototype.getTemporaryFileInfo = function (filename, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fsExtra.readJSON("".concat(this.getAbsoluteFilePath(userId, filename), ".metadata"))];
                    case 1:
                        metadata = _a.sent();
                        return [2 /*return*/, {
