...
var FileContentStorage = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        counter += 1;
                        p = path.join(this.getContentPath(), id.toString());
                        return [4 /*yield*/, fsExtra.pathExists(p)];
                    case 2:
                        exists = _a.sent();
                        _a.label = 3;
                    case 3:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 6, , 8]);
                        return [4 /*yield*/, fsExtra.ensureDir(path.join(this.getContentPath(), id.toString()))];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, fsExtra.writeJSON(path.join(this.getContentPath(), id.toString(), 'h5p.json'), metadata)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, fsExtra.writeJSON(path.join(this.getContentPath(), id.toString(), 'content.json'), content)];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 6:
                        error_1 = _a.sent();
                        return [4 /*yield*/, fsExtra.remove(path.join(this.getContentPath(), id.toString()))];
                    case 7:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fsExtra.pathExists(path.join(this.getContentPath(), id.toString()))];
                    case 1:
                        if (!(_a.sent())) {
                            throw new H5pError_1.default('storage-file-implementations:add-file-content-not-found', { filename: filename, id: id }, 404);
                        }
                        fullPath = path.join(this.getContentPath(), id.toString(), filename);
    ...
    FileContentStorage.prototype.contentExists = function (contentId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fsExtra.pathExists(path.join(this.getContentPath(), contentId.toString()))];
            });
        });
    };
    /**
    ...
    FileContentStorage.prototype.deleteContent = function (id, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fsExtra.pathExists(path.join(this.getContentPath(), id.toString()))];
                    case 1:
                        if (!(_a.sent())) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, filenameUtils_1.checkFilename)(filename);
                        absolutePath = path.join(this.getContentPath(), contentId.toString(), filename);
                        return [4 /*yield*/, fsExtra.pathExists(absolutePath)];
                    case 1:
                        if (!(_a.sent())) {
                            throw new H5pError_1.default('storage-file-implementations:delete-content-file-not-found', { filename: filename }, 404);
                        }
                        return [4 /*yield*/, fsExtra.remove(absolutePath)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (contentId !== undefined) {
                    return [2 /*return*/, fsExtra.pathExists(path.join(this.getContentPath(), contentId.toString(), filename))];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, fsExtra.stat(path.join(this.getContentPath(), id.toString(), filename))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, fsExtra.createReadStream(path.join(this.getContentPath(), id.toString(), filename), {
                                start: rangeStart,
                                end: rangeEnd
                            })];
                }
    ...
    FileContentStorage.prototype.listContent = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fsExtra.readdir(this.getContentPath())];
                    case 1:
                        directories = _a.sent();
                        return [4 /*yield*/, Promise.all(directories.map(function (dir) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, fsExtra.pathExists(path.join(this.getContentPath(), dir, 'h5p.json'))];
                                        case 1:
                                            if (!(_a.sent())) {
                                                return [2 /*return*/, ''];
                                            }
    ...
    FileContentStorage.prototype.listFiles = function (contentId, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        contentDirectoryPath = path.join(this.getContentPath(), contentId.toString());
                        contentDirectoryPathLength = contentDirectoryPath.length + 1;
                        return [4 /*yield*/, (0, get_all_files_1.getAllFiles)(path.join(contentDirectoryPath)).toArray()];
                    case 1:
                        absolutePaths = _a.sent();
                        contentPath = path.join(contentDirectoryPath, 'content.json');
                        h5pPath = path.join(contentDirectoryPath, 'h5p.json');
