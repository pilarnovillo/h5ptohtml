...
var ContentStorer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fsExtra.readJSON(path.join(packageDirectory, 'content', 'content.json'))];
                    case 1:
                        parameters = _a.sent();
                        return [4 /*yield*/, (0, get_all_files_1.getAllFiles)(path.join(packageDirectory, 'content')).toArray()];
                    case 2:
    ...
    ContentStorer.prototype.copyFromDirectoryToTemporary = function (metadata, packageDirectory, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fsExtra.readJSON(path.join(packageDirectory, 'content', 'content.json'))];
                    case 1:
                        parameters = _a.sent();
                    ...
                    case 3:
                        ...
                        filepath = path.join(packageDirectory, 'content', reference.filePath);
                    ...
                    case 4:
                        ...
                        readStream = fsExtra.createReadStream(filepath);
