...
//     const directory = path.resolve("C:\\Users\\piluc\\h5p server\\H5P-Nodejs-library\\packages\\h5p-html-exporter\\test\\h5p\\files"
//         // `${__dirname}/h5p/files`
//     );
//     let files;
//     try {
...
//     } catch {
//         throw new Error(`${__dirname}/h5p/files`+
